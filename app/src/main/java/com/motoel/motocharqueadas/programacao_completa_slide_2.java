...
public class programacao_completa_slide_2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.fragment_programacao_completa_slide_2, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        getActivity().setTitle(R.string.title_activity_tab_programacao_2);

        SqliteDatabase sql = new SqliteDatabase(getContext());
        String ret[] = sql.preencheEventos(11);
        String texto="";
        Spannable textoDestaque = new SpannableString("HI I am some text");
